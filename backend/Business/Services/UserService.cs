...
public class UserService : IUserService
{
    ...
    public async Task<PagedResult<User>> GetAllUsersAsync(int pageNumber, int pageSize)
    {
    ...
    public async Task<(bool Success, string Message)> UpdateUserProfileAsync(int userId, string? fullName,
        string? email, string? phoneNumber)
    {
        ...
        if (success)
        {
            await _auditService.LogAsync(userId, "User Profile Updated", "User", userId,
    ...
    public async Task<(bool Success, string Message)> LockUnlockUserAsync(int userId, bool isActive)
    {
        ...
        if (success)
        {
            ...
            await _auditService.LogAsync(null, $"User Account {action}", "User", userId,
                $"User {user.Username} account {action}.");
